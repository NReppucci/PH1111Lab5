 ...
 * PH1111 Lab 5 Momentum, Energy, and Error Propagation for Collision One
 */
public class labFiveErrorC1
{
    public static void main(String[] args)
    {
        ...
        cartSpringVelocityInit = 0.7015; // m/s from Logger Pro
        cartSpringVelocityFinal = 0.07825; // m/s " "
        cartSpringVelocityInitStDev = 0.06045; // m/s " "
        cartSpringVelocityFinalStDev = 0.01445; // m/s " " 
 
        cartHitVelocityInit = 0.0003862; // m/s from Logger Pro
        cartHitVelocityFinal = 0.5701; // m/s " "
        cartHitVelocityInitStDev = 0.002169; // m/s " "
        cartHitVelocityFinalStDev = 0.01877; // m/s " "
